 ...
 *
 *
 * Date:           Generated on         Wed May 13 17:28:12 2009
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/7630/rdb/b0/bchp_ddr23_phy_control_regs.h $
 * 
 ...
 ***************************************************************************/
#define BCHP_DDR23_PHY_CONTROL_REGS_REVISION     0x01805000 /* Address & Control revision register */
#define BCHP_DDR23_PHY_CONTROL_REGS_CLK_PM_CTRL  0x01805004 /* PHY clock power management control register */
#define BCHP_DDR23_PHY_CONTROL_REGS_PLL_STATUS   0x01805010 /* PHY PLL status register */
#define BCHP_DDR23_PHY_CONTROL_REGS_PLL_CONFIG   0x01805014 /* PHY PLL configuration register */
#define BCHP_DDR23_PHY_CONTROL_REGS_PLL_PRE_DIVIDER 0x01805018 /* PHY PLL pre-divider control register */
#define BCHP_DDR23_PHY_CONTROL_REGS_PLL_DIVIDER  0x0180501c /* PHY PLL divider control register */
#define BCHP_DDR23_PHY_CONTROL_REGS_PLL_CONTROL1 0x01805020 /* PHY PLL analog control register #1 i_pll_ctrl[31:0] see PLL spec */
#define BCHP_DDR23_PHY_CONTROL_REGS_PLL_CONTROL2 0x01805024 /* PHY PLL analog control register #2 i_pll_ctrl[37:32] see PLL spec */
#define BCHP_DDR23_PHY_CONTROL_REGS_PLL_SS_EN    0x01805028 /* PHY PLL spread spectrum config register */
#define BCHP_DDR23_PHY_CONTROL_REGS_PLL_SS_CFG   0x0180502c /* PHY PLL spread spectrum config register */
#define BCHP_DDR23_PHY_CONTROL_REGS_STATIC_VDL_OVERRIDE 0x01805030 /* Address & Control VDL static override control register */
#define BCHP_DDR23_PHY_CONTROL_REGS_DYNAMIC_VDL_OVERRIDE 0x01805034 /* Address & Control VDL dynamic override control register */
#define BCHP_DDR23_PHY_CONTROL_REGS_IDLE_PAD_CONTROL 0x01805038 /* Idle mode SSTL pad control register */
#define BCHP_DDR23_PHY_CONTROL_REGS_ZQ_PVT_COMP_CTL 0x0180503c /* PVT Compensation control and status register */
#define BCHP_DDR23_PHY_CONTROL_REGS_DRIVE_PAD_CTL 0x01805040 /* SSTL pad drive characteristics control register */
#define BCHP_DDR23_PHY_CONTROL_REGS_CLOCK_REG_CONTROL 0x01805044 /* Clock Regulator control register */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONTROL 0x0180505c /* Virtual VTT Control and Status register */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_STATUS 0x01805060 /* Virtual VTT Control and Status register */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONNECTIONS 0x01805064 /* Virtual VTT Connections register */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_OVERRIDE 0x01805068 /* Virtual VTT Override register */
#define BCHP_DDR23_PHY_CONTROL_REGS_STANDBY_PWR_1 0x01805070 /* Standby Power control register #1 */
#define BCHP_DDR23_PHY_CONTROL_REGS_STANDBY_PWR_2 0x01805080 /* Standby Power control register #2 */
...
/***************************************************************************
 *PLL_CONTROL1 - PHY PLL analog control register #1 i_pll_ctrl[31:0] see PLL spec
 ***************************************************************************/
...
/***************************************************************************
 *PLL_CONTROL2 - PHY PLL analog control register #2 i_pll_ctrl[37:32] see PLL spec
 ***************************************************************************/
 ...
 ***************************************************************************/
/* DDR23_PHY_CONTROL_REGS :: VIRTUAL_VTT_CONTROL :: reserved0 [31:04] */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONTROL_reserved0_MASK 0xfffffff0
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONTROL_reserved0_SHIFT 4

/* DDR23_PHY_CONTROL_REGS :: VIRTUAL_VTT_CONTROL :: error_reset [03:03] */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONTROL_error_reset_MASK 0x00000008
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONTROL_error_reset_SHIFT 3

/* DDR23_PHY_CONTROL_REGS :: VIRTUAL_VTT_CONTROL :: enable_ctl_idle [02:02] */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONTROL_enable_ctl_idle_MASK 0x00000004
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONTROL_enable_ctl_idle_SHIFT 2

/* DDR23_PHY_CONTROL_REGS :: VIRTUAL_VTT_CONTROL :: enable_cs_idle [01:01] */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONTROL_enable_cs_idle_MASK 0x00000002
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONTROL_enable_cs_idle_SHIFT 1

/* DDR23_PHY_CONTROL_REGS :: VIRTUAL_VTT_CONTROL :: enable_cke_idle [00:00] */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONTROL_enable_cke_idle_MASK 0x00000001
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONTROL_enable_cke_idle_SHIFT 0

/***************************************************************************
 *VIRTUAL_VTT_STATUS - Virtual VTT Control and Status register
 ***************************************************************************/
/* DDR23_PHY_CONTROL_REGS :: VIRTUAL_VTT_STATUS :: reserved0 [31:03] */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_STATUS_reserved0_MASK 0xfffffff8
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_STATUS_reserved0_SHIFT 3

/* DDR23_PHY_CONTROL_REGS :: VIRTUAL_VTT_STATUS :: error_low [02:02] */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_STATUS_error_low_MASK 0x00000004
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_STATUS_error_low_SHIFT 2

/* DDR23_PHY_CONTROL_REGS :: VIRTUAL_VTT_STATUS :: error_high [01:01] */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_STATUS_error_high_MASK 0x00000002
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_STATUS_error_high_SHIFT 1

/* DDR23_PHY_CONTROL_REGS :: VIRTUAL_VTT_STATUS :: ready [00:00] */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_STATUS_ready_MASK  0x00000001
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_STATUS_ready_SHIFT 0

/***************************************************************************
 *VIRTUAL_VTT_CONNECTIONS - Virtual VTT Connections register
 ***************************************************************************/
/* DDR23_PHY_CONTROL_REGS :: VIRTUAL_VTT_CONNECTIONS :: reserved0 [31:27] */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONNECTIONS_reserved0_MASK 0xf8000000
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONNECTIONS_reserved0_SHIFT 27

/* DDR23_PHY_CONTROL_REGS :: VIRTUAL_VTT_CONNECTIONS :: mask [26:00] */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONNECTIONS_mask_MASK 0x07ffffff
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_CONNECTIONS_mask_SHIFT 0

/***************************************************************************
 *VIRTUAL_VTT_OVERRIDE - Virtual VTT Override register
 ***************************************************************************/
/* DDR23_PHY_CONTROL_REGS :: VIRTUAL_VTT_OVERRIDE :: reserved0 [31:27] */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_OVERRIDE_reserved0_MASK 0xf8000000
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_OVERRIDE_reserved0_SHIFT 27

/* DDR23_PHY_CONTROL_REGS :: VIRTUAL_VTT_OVERRIDE :: mask [26:00] */
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_OVERRIDE_mask_MASK 0x07ffffff
#define BCHP_DDR23_PHY_CONTROL_REGS_VIRTUAL_VTT_OVERRIDE_mask_SHIFT 0

/***************************************************************************
 *STANDBY_PWR_1 - Standby Power control register #1
 ***************************************************************************/
/* DDR23_PHY_CONTROL_REGS :: STANDBY_PWR_1 :: reserved0 [31:04] */
#define BCHP_DDR23_PHY_CONTROL_REGS_STANDBY_PWR_1_reserved0_MASK   0xfffffff0
#define BCHP_DDR23_PHY_CONTROL_REGS_STANDBY_PWR_1_reserved0_SHIFT  4

/* DDR23_PHY_CONTROL_REGS :: STANDBY_PWR_1 :: standby [03:00] */
#define BCHP_DDR23_PHY_CONTROL_REGS_STANDBY_PWR_1_standby_MASK     0x0000000f
#define BCHP_DDR23_PHY_CONTROL_REGS_STANDBY_PWR_1_standby_SHIFT    0

/***************************************************************************
 *STANDBY_PWR_2 - Standby Power control register #2
 ***************************************************************************/
/* DDR23_PHY_CONTROL_REGS :: STANDBY_PWR_2 :: reserved0 [31:04] */
#define BCHP_DDR23_PHY_CONTROL_REGS_STANDBY_PWR_2_reserved0_MASK   0xfffffff0
#define BCHP_DDR23_PHY_CONTROL_REGS_STANDBY_PWR_2_reserved0_SHIFT  4

/* DDR23_PHY_CONTROL_REGS :: STANDBY_PWR_2 :: standby [03:00] */
#define BCHP_DDR23_PHY_CONTROL_REGS_STANDBY_PWR_2_standby_MASK     0x0000000f
#define BCHP_DDR23_PHY_CONTROL_REGS_STANDBY_PWR_2_standby_SHIFT    0
