...
#define BCM_LINUX_SATA1_IRQ		(1+32+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_PCI_SATA1_CPU_INTR_SHIFT)
...
#define BCM_LINUX_SHARF_IRQ		(1+32+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_SHIFT_CPU_INTR_SHIFT) /* 36*/
