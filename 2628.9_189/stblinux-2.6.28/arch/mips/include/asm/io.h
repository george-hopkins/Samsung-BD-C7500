...
#define UPPER_RAM_SIZE 	0x00000000UL	// ignore upper RAM
#define UPPER_RAM_VBASE 0xe0000000UL
#else
#define UPPER_RAM_SIZE 	0x20000000UL	// 512MB
...
#define LOWER_RAM_SIZE 	0x10000000UL	// 256MB
	...
	if ((address >= UPPER_RAM_BASE) && (address < (UPPER_RAM_BASE + UPPER_RAM_SIZE)))
		return (void *)((address - UPPER_RAM_BASE) + UPPER_RAM_VBASE);
#endif
