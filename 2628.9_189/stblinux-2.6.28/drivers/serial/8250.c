...
serial_out(struct uart_8250_port *up, int offset, unsigned int value)
{
 ...
 #define serial_out(up, offset, value) __serial_out(up, offset, value)
...
static unsigned int serial8250_get_divisor(struct uart_port *port, unsigned int baud)
{
	...
	/*
	 * Brute force the divisor so we can set any baud rate to match the HW emulator
	 */
	quot = CONFIG_HW_EMULATOR_UART_DIVISOR;
#else
	/*
