...
static int __devinit ehci_hcd_brcm_probe(struct platform_device *pdev)
{
...
static int __devexit ehci_hcd_brcm_remove(struct platform_device *pdev)
{
...
static struct platform_driver ehci_hcd_brcm_driver = {
	...
	.remove = __devexit_p(ehci_hcd_brcm_remove),
