...
#define CDROM_READ_CAPACITY	0x5396	/* get block capacity of the disc */
#endif
...
#if defined (CONFIG_MIPS_BCM_NDVD)
/*
 * Supported vendor-unique commands
 */
#define GPCMD_V0_ENABLE_DIAG_MODE           0xf0
#define GPCMD_V0_GET_CHECKSUM               0xf4
#define GPCMD_V0_FLASH_COMMAND              0xfa

#define GPCMD_V1_REPORT_KEY		    0xe7
#define GPCMD_V1_SEND_KEY		    0xe8
#define GPCMD_V1_READ_DVD_STRUCTURE	    0xed

#define GPCMD_V2_READ_RECORDER		    0xee
#define GPCMD_V2_SEND_RECORDER		    0xef
...
#if defined (CONFIG_MIPS_BCM_NDVD)
extern int cdrom_read_capacity(struct cdrom_device_info *cdi, long *capacity);
#endif
