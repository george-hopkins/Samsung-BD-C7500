...
#if defined (CONFIG_MIPS_BCM_NDVD)
	ATA_DFLAG_EARLY_SPINUP	= (1 << 26), /* send early spinup to device */
#endif
...
#if defined (CONFIG_MIPS_BCM_NDVD)
	ATA_FLAG_VIDE_OFE	= (1 << 24), /* port is VIDE OFE */
	VIDE_OFE_FLAG_NO_ATAPI_DMA = (1 << 25),
#endif
...
#if defined (CONFIG_MIPS_BCM_NDVD)
	ATA_TMOUT_BOOT		= 10000,	/* hueristic */
	ATA_TMOUT_BOOT_QUICK	= 5000,		/* hueristic */
	ATA_TMOUT_INTERNAL	= 10000,
#else
...
/* VIDE/OFE */
extern void vide_ofe_hardreset(void);
#endif
