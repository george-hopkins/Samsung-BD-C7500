...
//************************************************************ for Divx Drm
	DRMInfo	sDRMinfo;
//************************************************************ for Divx Drm
/*! for PES header data, clin.li@SCRC for iplayer application, 2009.10.9  */
#define MAX_PES_HEADER_LENGTH		255 			// sunye add less then 49 actually     
    uint8_t header[MAX_PES_HEADER_LENGTH]; 			//sunye add	
/*! end clin.li */
...
#define FF_COMPRESSION_DEFAULT -1
	...
	/* Modified by Mincheol Seo 2009/6/3 */
    long mjpeg_skip_byte;
    int user_info; // fscherry : set addtional info for aac
	/* Mincheol Seo for jpeg*/
	char isStillImage;	
} AVCodecContext;
...
// for LATM DTS correction.. FSCHERRY
    int frame_count_inbuffer;
    int previous_frame_start_index;
