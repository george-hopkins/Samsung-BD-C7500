...
/* Only (re)define _XOPEN_SOURCE if it is less than the required value;
   -D_GNU_SOURCE in particular will usually select the latest available
   version.  We do not undef the macro before redefining it because we
   want to alert the user to any unexpected increase in the macro's value.  */
