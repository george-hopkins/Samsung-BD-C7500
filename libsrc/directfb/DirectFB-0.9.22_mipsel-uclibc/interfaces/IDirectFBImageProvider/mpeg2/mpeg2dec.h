...
typedef void (*MPEG2_Scale)(void *ctx);
...
int  MPEG2_DecodeAndScale(MPEG2_Decoder *dec, MPEG2_Write mpeg2_write, void *write_ctx, MPEG2_Scale mpeg2_scale);
void MPEG2_Close(MPEG2_Decoder *dec);
void MPEG2_Stop(MPEG2_Decoder *dec);
