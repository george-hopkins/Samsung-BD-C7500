...
typedef struct
{
	...
	/* public */
	int16	curveType;		/* 2 or 3 */
	int16	contourCount;	/* number of contours in the character */
	int16	pointCount;		/* number of points in the characters + 0 for the sidebearing points */
	...
	int8	dropOutControl; /* true if on, false otherwise */
	uint16	myGlyphIndex;
} GlyphClass;
 ...
 *  
 *     $Header: /encentrus/Andover/juju-20060206-1447/ndvd/directfb/directfb_deps_source/FontFusion_3.1/FontFusion_3.1_SDK/core/glyph.h,v 1.1 2006/02/08 17:20:43 xmiville Exp $
 *                                                                           *
 *     $Log: glyph.h,v $
 ...
 *     *** empty log message ***
 *
 *     Revision 1.10  2003/01/06 20:34:14  Shawn_Flynn
 *     dtypED.
 *     
