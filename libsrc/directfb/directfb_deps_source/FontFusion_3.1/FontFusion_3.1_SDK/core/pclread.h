...
typedef struct
{
	...
	int8	*copyright;		/* 80 + .scal_data_size + 3 ...	*/
 ...
 *	 $Header: /encentrus/Andover/juju-20060206-1447/ndvd/directfb/directfb_deps_source/FontFusion_3.1/FontFusion_3.1_SDK/core/pclread.h,v 1.1 2006/02/08 17:20:43 xmiville Exp $
 *																		   *
 *	 $Log: pclread.h,v $
 ...
 *	 *** empty log message ***
 *	
 *	 Revision 1.6  2003/01/07 17:54:51  Shawn_Flynn
 *	 dtypED.
 *	 
 *	 Revision 1.5  2002/03/12 15:04:43  Shawn_Flynn
 *	 Added member glyphExists to PCLClass definition.
 *	 
