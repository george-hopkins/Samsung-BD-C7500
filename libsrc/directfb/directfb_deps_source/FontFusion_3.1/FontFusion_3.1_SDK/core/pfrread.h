...
typedef struct pfrGlyphInfoData_tag
{
	...
	uint8		*tempBuffer;
	uint8		*dst;	/* the place where SetBitmapBits will write */
}pfrGlyphInfoData;
...
/*	int16  *BlueValues; */
	int32			BlueValues[PFR_MAX_BLUEVALUES];  /* 0 .. (numBlueValues-1) */
	int32			numBlueValues;
	int32			BlueFuzz;
	F16Dot16		BlueScale;
	int32			BlueShift;
 ...
 *     $Header: /encentrus/Andover/juju-20060206-1447/ndvd/directfb/directfb_deps_source/FontFusion_3.1/FontFusion_3.1_SDK/core/pfrread.h,v 1.1 2006/02/08 17:20:43 xmiville Exp $
 *                                                                           *
 *     $Log: pfrread.h,v $
 ...
 *     *** empty log message ***
 *
 *     Revision 1.22  2003/01/07 18:05:30  Shawn_Flynn
 *     dtypED.
 *     
