...
typedef void *(*FF_FM_RenderGlyphPtr)( void *theFM, uint16 fontCode, void **ppScaler, int32 code, int8 xFracPenDelta, int8 yFracPenDelta, uint8 greyScaleLevel, uint16 cmd, int *errCode );
...
/* Query method for checking if the font contains any sbits */
#ifndef ENABLE_BDF
#define T2K_FontSbitsExists( t2k ) ((t2k)->font->bloc != NULL)
#else
#define T2K_FontSbitsExists( t2k ) (((t2k)->font->bloc != NULL) || ((t2k)->font->bdf != NULL))
#endif /* ENABLE_BDF */
 ...
 *
 */
void T2K_RenderGlyph(T2K *t, int32 code, int8 xFracPenDelta, int8 yFracPenDelta,
 ...
 */
T2K_KernPair *T2K_FindKernPairs(T2K *t, uint16 *baseSet, int baseLength, uint16 charCode,
								int *pairCountPtr );
 ...
 */
int FF_GlyphExists( T2K *t, int32 code, uint16 cmd, int *errCode );
 ...
 *  
 *     $Header: /encentrus/Andover/juju-20060206-1447/ndvd/directfb/directfb_deps_source/FontFusion_3.1/FontFusion_3.1_SDK/core/t2k.h,v 1.1 2006/02/08 17:20:43 xmiville Exp $
 *                                                                           *
 *     $Log: t2k.h,v $
