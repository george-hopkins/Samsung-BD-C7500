...
typedef struct
{
	...
	uint8	substituteBitDepth, bitDepth;		/* Bit depth, 1 for monochrome data. */
 ...
 */
int FindGlyph_blocClass(blocClass *t, ebscClass *ebsc, InputStream *in, uint16 glyphIndex,
 ...
 *  
 *     $Header: /encentrus/Andover/juju-20060206-1447/ndvd/directfb/directfb_deps_source/FontFusion_3.1/FontFusion_3.1_SDK/core/t2ksbit.h,v 1.1 2006/02/08 17:20:43 xmiville Exp $
 *                                                                           *
 *     $Log: t2ksbit.h,v $
 ...
 *     *** empty log message ***
 *
 *     Revision 1.10  2005/09/15 19:32:46  Shawn_Flynn
 *     Added support for sbit transformations.
 *     
 *     Revision 1.9  2004/10/29 15:32:13  Shawn_Flynn
 *     Added gInfo structure member 'substituteBitDepth' to track bit depth
 *     converted bitmaps.
 *     
 *     Revision 1.8  2004/09/29 16:51:05  Shawn_Flynn
 *     Added requestedBitDepth member for multi-bit-per-pixel bitmap access.
 *     
 *     Revision 1.7  2003/07/30 15:54:54  Reggers
 *     Have black value for scaling embedded SBITS passed in.
 *     Revision 1.6  2003/01/07 20:41:08  Shawn_Flynn
 *     dtypED.
 *     
