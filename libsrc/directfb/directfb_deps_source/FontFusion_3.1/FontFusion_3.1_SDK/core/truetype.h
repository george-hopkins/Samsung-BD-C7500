...
typedef void (*StyleFuncPtr)( GlyphClass *glyph, tsiMemObject *mem, int16 UPEM, F16Dot16 params[] );
...
void setT2KScaleFactors( int32 pixelsPerEm, int32 UPEM, T2KScaleInfo *si );
 ...
 */
GlyphClass *GetGlyphByIndex( sfntClass *t, int32 index, int8 readHints, uint16 *aWidth, uint16 *aHeight );
/*
 ...
 *  
 *     $Header: /encentrus/Andover/juju-20060206-1447/ndvd/directfb/directfb_deps_source/FontFusion_3.1/FontFusion_3.1_SDK/core/truetype.h,v 1.1 2006/02/08 17:20:43 xmiville Exp $
 *                                                                           *
 *     $Log: truetype.h,v $
